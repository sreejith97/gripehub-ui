    ...
    <div className="lg:px-10 px-4 flex flex-col items-center justify-center ">
      ...
      <div className="my-6 w-full lg:w-auto flex flex-col lg:flex-row justify-center items-center lg:gap-10">
        ...
        <div
          ...
          onClick={() => {
            router.push("/user/addComplaints");
          }}
        >
          Add Complaints
        </div>
        ...
        {complaints ? (
          complaints.length > 0 ? (
            <div className="max-w-full overflow-x-hidden">
              <ComplaintList complaints={complaints} isUser={isUser} />
            </div>
          ) : (
            "No complaints has been registerd in your email"
          )
        ) : isTableLoading ? (
          "Loading table"
        ) : (
